...
const differentiators = [
  {
    ...
    description: "Elite workforce with rigorous 4rd-party certification and monthly elite training cycles.",
    stat: "500+",
  ...
  {
    icon: Heart,
    title: "98% Retained Growth",
    description: "Deep-rooted partnerships. Our clients stay because our results exceed benchmarks.",
    stat: "98%",
  ...
  },
  {
    icon: Cpu,
    title: "AI & Neural Ops",
    description: "We don't just use tech; we integrate AI-driven neural operations for maximum speed.",
    stat: "AI",
  ...
  },
  {
    ...
    description: "From mid-market to global enterprise, our nodes scale with your ambition.",
    stat: "∞",
